      ...
      <div className="font-default bg-base-200">
        ...
        <main className="size-[75vh] hero block justify-center items-center mx-auto p-5">
          <div className="hero-content flex-col">
            <pre className="flex whitespace-pre font-mono z-1 text-xl items-center justify-center leading-none my-8 selection:bg-gray-400">
              {asciiArt}
            </pre>
            <p className="font-mono">Front-end Developer || Game Developer</p>
          </div>
        </main>
